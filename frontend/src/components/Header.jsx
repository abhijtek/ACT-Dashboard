...
function Header({ theme, setTheme }) {
  ...
  const navItems = [
    ...
    { name: "Account", slug: "/account-details", active: authStatus },
      ...
      <Container className="py-3">
        <nav className="surface-soft flex items-center justify-between rounded-2xl px-3 py-2 sm:px-4">
          <Link to="/" className="interactive flex items-center gap-3 rounded-xl px-2 py-1.5">
            <Logo width="52px" />
            <div>
              <p className="text-sm font-semibold text-app">Admino</p>
              <p className="text-[11px] text-muted">User Management</p>
            </div>
          </Link>
